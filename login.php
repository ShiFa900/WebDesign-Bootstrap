...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;500;600;700&family=Rubik:wght@400;500;600;700&display=swap"
          rel="stylesheet"/>
                    ...
                    <div class="login-form-wrapper px-3">
                        ...
                        <form class="login-form" action="action/action-login.php" method="post" name="login-form">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <input name="email" id="staticEmail" type="email" placeholder="Email" required
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="mb-3 row">
