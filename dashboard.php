...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600&family=Open+Sans:wght@400;500;600;700&family=Rubik:wght@400;500;600;700&display=swap"
          rel="stylesheet"/>
...
<header class="header sticky-top d-flex align-items-center justify-content-between">
    ...
    <div class="head-wrapper d-flex align-items-center">
        <button class="btn btn-primary d-xxl-none d-xl-none d-lg-none" type="button" data-bs-toggle="offcanvas"
